...
namespace ManejoPresupuesto.Controllers
{
    ...
    public class TransaccionesController : Controller
    {
        ...
        public TransaccionesController(IServiciosUsuarios serviciosUsuarios, IRepositorioTransacciones repositorioTransacciones, IRepositorioCuentas repositorioCuentas, IRepositorioCategorias repositorioCategorias, IMapper mapper, IServicioReportes servicioReportes)
        {
        ...
        public async Task<IActionResult> Semanal(int mes,int año)
        {
            ...
            model.TransaccionesPorSemana = agrupado;
            model.FechaReferencia = fechaReferencia;
        ...
        public async Task<FileResult> ExportarExcelTodo()
        {
            ...
            var nombreArchivo = $"Manejo Presupuesta - {DateTime.Today.ToString("dd-MM-yyyy")}.xlsx";
        ...
        private FileResult GenerarExcel(string nombreArchivo, IEnumerable<Transaccion> transacciones)
        {
            ...
            {
                dataTable.Rows.Add(transaccion.FechaTransaccion.ToString("dd-MMMM-yyyy"), transaccion.Cuenta,
